...
class page 
{
 ...
 var $styles=array();//链接式样 pre_page next_page first_page last_page nowbar nowindex
 ...
 function next_page($style='')
 {
  ...
  //$style = $style?$style:$this->styles['next_page'];
 ...
 function pre_page($style='')
 {
  ...
  //$style = $style?$style:$this->styles['pre_page'];
 ...
 function first_page($style='')
 {
  ...
  $style = $style?$style:$this->styles['first_page'];
 ...
 function last_page($style='')
 {
  ...
  $style = $style?$style:$this->styles['last_page'];
  return $this->_get_link($this->_get_url($this->totalpage),$this->last_page,$style);
 }
 
 function nowbar($style='',$nowindex_style='')
 {
  $style = $style?$style:$this->styles['nowbar'];
  $nowindex_style = $nowindex_style?$nowindex_style:$this->styles['nowindex'];
